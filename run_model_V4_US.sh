...
python DELPHI_model_V3_predict_additional_state.py -d "2020-10-01" -t 'US' -dt '071621'

python DELPHI_model_V4_additional_states.py -rc run_configs/annealing-run-config.yml -t 'US' -d '071621'
