...
python DELPHI_model_V3_predict_additional_state.py -d "2020-10-01" -t 'ExUS' -g 'false' -dt '070921'

python DELPHI_model_V4_additional_states.py -rc run_configs/annealing-run-config.yml -t 'ExUS' -g 'false' -weekago 'true'  -d '070921'
